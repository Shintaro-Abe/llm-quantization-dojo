...
When the user requests an AWS architecture diagram, before generating XML,
read the AWS official guidelines reference at:

`.claude/skills/drawio/references/aws-guidelines.md` (project-scoped install)
or
`~/.claude/skills/drawio/references/aws-guidelines.md` (global install)

This file contains the official AWS Architecture Icons guidelines (Release 22-2025.07.31)
covering group containers, icon rules, arrow styles, label conventions, and validation
checklist. Do NOT proceed with AWS diagram generation without consulting this reference.