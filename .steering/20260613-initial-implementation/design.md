...
- Colabバッジ URL: `https://colab.research.google.com/github/OWNER/REPO/blob/main/notebooks/01_bitsandbytes_qlora.ipynb`（`OWNER/REPO` はリポジトリ確定後に差し込む。座学 index.md にも同バッジ）。
